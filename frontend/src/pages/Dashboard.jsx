...
// Filter modal component extracted outside Dashboard to avoid re-mount on every render
function FilterModal({ column, values = [], selected = [], onToggle, onSelectAll, onClearAll, onClose, filterSearches, setFilterSearches }) {
...
export default function Dashboard() {
  ...
  const monthly = computeMonthly(datasets)
